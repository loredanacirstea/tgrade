...
func TestParseChainID(t *testing.T) {
	testCases := []struct {
		...
		{
			"valid chain-id, single digit", "ewasm_1-1", false, big.NewInt(1),
		},
		{
		...
		{
			"invalid chain-id, uppercases", "EWASM_1-1", true, nil,
		},
		{
			"invalid chain-id, mixed cases", "Ewasm_1-1", true, nil,
		},
		{
			"invalid chain-id, special chars", "$&*#!_1-1", true, nil,
		},
		{
			"invalid eip155 chain-id, cannot start with 0", "ewasm_001-1", true, nil,
		},
		{
			"invalid eip155 chain-id, cannot invalid base", "ewasm_0x212-1", true, nil,
		},
		{
			"invalid eip155 chain-id, non-integer", "ewasm_ewasm_9000-1", true, nil,
		},
		{
			"invalid epoch, undefined", "ewasm_-", true, nil,
		},
		{
		...
		{
			"long chain-id", "ewasm_" + strings.Repeat("1", 40) + "-1", true, nil,
		},
	}
