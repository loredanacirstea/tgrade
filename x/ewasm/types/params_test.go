...
func TestParamsValidate(t *testing.T) {
	testCases := []struct {
		...
		{
			"valid",
			NewParams(true, "ara", true, true, DefaultChainConfig(), 2929, 1884, 1344),
			false,
		},
		{
			"empty",
		...
		{
			"invalid: disabled",
			NewParams(false, "ara", true, true, DefaultChainConfig(), 2929, 1884, 1344),
			false,
		},
		{
			"invalid evm denom",
...
func TestParamsEIPs(t *testing.T) {
	params := NewParams(true, "ara", true, true, DefaultChainConfig(), 2929, 1884, 1344)
	actual := params.EIPs()
