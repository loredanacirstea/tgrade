...
// source: confio/ewasm/v1beta1/ewasm.proto
...
// Params defines the Ewasm module parameters
type Params struct {
	// enable_ewasm defines a parameter to enable the ewasm module
	EnableEwasm bool `protobuf:"varint,1,opt,name=enable_ewasm,json=enableEwasm,proto3" json:"enable_ewasm,omitempty"`
	// evm denom represents the token denomination used to run the EVM state
	// transitions.
	EvmDenom string `protobuf:"bytes,2,opt,name=evm_denom,json=evmDenom,proto3" json:"evm_denom,omitempty" yaml:"evm_denom"`
	// enable create toggles state transitions that use the vm.Create function
	EnableCreate bool `protobuf:"varint,3,opt,name=enable_create,json=enableCreate,proto3" json:"enable_create,omitempty" yaml:"enable_create"`
	// enable call toggles state transitions that use the vm.Call function
	EnableCall bool `protobuf:"varint,4,opt,name=enable_call,json=enableCall,proto3" json:"enable_call,omitempty" yaml:"enable_call"`
	// extra eips defines the additional EIPs for the vm.Config
	ExtraEIPs []int64 `protobuf:"varint,5,rep,packed,name=extra_eips,json=extraEips,proto3" json:"extra_eips,omitempty" yaml:"extra_eips"`
	// chain config defines the EVM chain configuration parameters
	ChainConfig ChainConfig `protobuf:"bytes,6,opt,name=chain_config,json=chainConfig,proto3" json:"chain_config" yaml:"chain_config"`
...
func (*Params) Descriptor() ([]byte, []int) {
	return fileDescriptor_94341a9dab11353b, []int{0}
}
...
func (m *Params) GetEnableEwasm() bool {
	if m != nil {
		return m.EnableEwasm
	}
	return false
}
...
func (*ChainConfig) Descriptor() ([]byte, []int) {
	return fileDescriptor_94341a9dab11353b, []int{1}
}
...
func (*State) Descriptor() ([]byte, []int) {
	return fileDescriptor_94341a9dab11353b, []int{2}
}
...
func (*TransactionLogs) Descriptor() ([]byte, []int) {
	return fileDescriptor_94341a9dab11353b, []int{3}
}
...
func (*Log) Descriptor() ([]byte, []int) {
	return fileDescriptor_94341a9dab11353b, []int{4}
}
...
func (*TxResult) Descriptor() ([]byte, []int) {
	return fileDescriptor_94341a9dab11353b, []int{5}
}
...
func (*AccessTuple) Descriptor() ([]byte, []int) {
	return fileDescriptor_94341a9dab11353b, []int{6}
}
...
func (*TraceConfig) Descriptor() ([]byte, []int) {
	return fileDescriptor_94341a9dab11353b, []int{7}
}
...
func init() {
	proto.RegisterType((*Params)(nil), "confio.ewasm.v1beta1.Params")
	proto.RegisterType((*ChainConfig)(nil), "confio.ewasm.v1beta1.ChainConfig")
	proto.RegisterType((*State)(nil), "confio.ewasm.v1beta1.State")
	proto.RegisterType((*TransactionLogs)(nil), "confio.ewasm.v1beta1.TransactionLogs")
	proto.RegisterType((*Log)(nil), "confio.ewasm.v1beta1.Log")
	proto.RegisterType((*TxResult)(nil), "confio.ewasm.v1beta1.TxResult")
	proto.RegisterType((*AccessTuple)(nil), "confio.ewasm.v1beta1.AccessTuple")
	proto.RegisterType((*TraceConfig)(nil), "confio.ewasm.v1beta1.TraceConfig")
}

func init() { proto.RegisterFile("confio/ewasm/v1beta1/ewasm.proto", fileDescriptor_94341a9dab11353b) }

var fileDescriptor_94341a9dab11353b = []byte{
	...
	,
}
...
func (m *Params) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	}
	{
		...
		i -= size
		i = encodeVarintEwasm(dAtA, i, uint64(size))
	}
	i--
	dAtA[i] = 0x32
	if len(m.ExtraEIPs) > 0 {
		...
		i = encodeVarintEwasm(dAtA, i, uint64(j2))
		i--
		dAtA[i] = 0x2a
	}
	if m.EnableCall {
	...
	if len(m.EvmDenom) > 0 {
		...
		i = encodeVarintEwasm(dAtA, i, uint64(len(m.EvmDenom)))
		i--
		dAtA[i] = 0x12
	}
	if m.EnableEwasm {
...
func (m *ChainConfig) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	if len(m.EIP150Hash) > 0 {
		...
		i = encodeVarintEwasm(dAtA, i, uint64(len(m.EIP150Hash)))
		i--
		dAtA[i] = 0x2a
	}
...
func (m *State) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	if len(m.Value) > 0 {
		i -= len(m.Value)
		copy(dAtA[i:], m.Value)
		i = encodeVarintEwasm(dAtA, i, uint64(len(m.Value)))
		i--
		dAtA[i] = 0x12
	}
	if len(m.Key) > 0 {
		i -= len(m.Key)
		copy(dAtA[i:], m.Key)
		i = encodeVarintEwasm(dAtA, i, uint64(len(m.Key)))
		i--
		dAtA[i] = 0xa
	}
	return len(dAtA) - i, nil
...
func (m *TransactionLogs) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	if len(m.Hash) > 0 {
		i -= len(m.Hash)
		copy(dAtA[i:], m.Hash)
		i = encodeVarintEwasm(dAtA, i, uint64(len(m.Hash)))
		i--
		dAtA[i] = 0xa
	}
	return len(dAtA) - i, nil
...
func (m *Log) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	if m.Index != 0 {
		i = encodeVarintEwasm(dAtA, i, uint64(m.Index))
		i--
		dAtA[i] = 0x40
	}
	if len(m.BlockHash) > 0 {
		...
		i = encodeVarintEwasm(dAtA, i, uint64(len(m.BlockHash)))
		i--
		dAtA[i] = 0x3a
	}
	if m.TxIndex != 0 {
		i = encodeVarintEwasm(dAtA, i, uint64(m.TxIndex))
		i--
		dAtA[i] = 0x30
	}
	if len(m.TxHash) > 0 {
		...
		i = encodeVarintEwasm(dAtA, i, uint64(len(m.TxHash)))
		i--
		dAtA[i] = 0x2a
	}
	if m.BlockNumber != 0 {
		i = encodeVarintEwasm(dAtA, i, uint64(m.BlockNumber))
		i--
		dAtA[i] = 0x20
	}
	if len(m.Data) > 0 {
		i -= len(m.Data)
		copy(dAtA[i:], m.Data)
		i = encodeVarintEwasm(dAtA, i, uint64(len(m.Data)))
		i--
		dAtA[i] = 0x1a
	}
	if len(m.Topics) > 0 {
		for iNdEx := len(m.Topics) - 1; iNdEx >= 0; iNdEx-- {
			...
			i = encodeVarintEwasm(dAtA, i, uint64(len(m.Topics[iNdEx])))
			i--
			dAtA[i] = 0x12
		}
	}
	if len(m.Address) > 0 {
		...
		i = encodeVarintEwasm(dAtA, i, uint64(len(m.Address)))
		i--
		dAtA[i] = 0xa
	}
	return len(dAtA) - i, nil
...
func (m *TxResult) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	_ = l
	if m.GasUsed != 0 {
		i = encodeVarintEwasm(dAtA, i, uint64(m.GasUsed))
		i--
		dAtA[i] = 0x30
	}
	if m.Reverted {
	...
	if len(m.Ret) > 0 {
		i -= len(m.Ret)
		copy(dAtA[i:], m.Ret)
		i = encodeVarintEwasm(dAtA, i, uint64(len(m.Ret)))
		i--
		dAtA[i] = 0x22
	}
	{
	...
	if len(m.Bloom) > 0 {
		i -= len(m.Bloom)
		copy(dAtA[i:], m.Bloom)
		i = encodeVarintEwasm(dAtA, i, uint64(len(m.Bloom)))
		i--
		dAtA[i] = 0x12
	}
	if len(m.ContractAddress) > 0 {
		...
		i = encodeVarintEwasm(dAtA, i, uint64(len(m.ContractAddress)))
		i--
		dAtA[i] = 0xa
	}
	return len(dAtA) - i, nil
...
func (m *AccessTuple) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	if len(m.StorageKeys) > 0 {
		for iNdEx := len(m.StorageKeys) - 1; iNdEx >= 0; iNdEx-- {
			...
			i = encodeVarintEwasm(dAtA, i, uint64(len(m.StorageKeys[iNdEx])))
			i--
			dAtA[i] = 0x12
		}
	}
...
func (m *TraceConfig) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	if m.Limit != 0 {
		i = encodeVarintEwasm(dAtA, i, uint64(m.Limit))
		i--
		dAtA[i] = 0x48
	}
	if m.Debug {
	...
	if m.Reexec != 0 {
		i = encodeVarintEwasm(dAtA, i, uint64(m.Reexec))
		i--
		dAtA[i] = 0x18
	}
	if len(m.Timeout) > 0 {
		...
		i = encodeVarintEwasm(dAtA, i, uint64(len(m.Timeout)))
		i--
		dAtA[i] = 0x12
	}
	if len(m.Tracer) > 0 {
		...
		i = encodeVarintEwasm(dAtA, i, uint64(len(m.Tracer)))
		i--
		dAtA[i] = 0xa
	}
	return len(dAtA) - i, nil
...
func encodeVarintEwasm(dAtA []byte, offset int, v uint64) int {
	offset -= sovEwasm(v)
	base := offset
	for v >= 1<<7 {
...
func (m *Log) Size() (n int) {
	...
	if m.BlockNumber != 0 {
		n += 1 + sovEwasm(uint64(m.BlockNumber))
	}
	l = len(m.TxHash)
	if l > 0 {
		n += 1 + l + sovEwasm(uint64(l))
...
func sovEwasm(x uint64) (n int) {
	return (math_bits.Len64(x|1) + 6) / 7
}
func sozEwasm(x uint64) (n int) {
	return sovEwasm(uint64((x << 1) ^ uint64((int64(x) >> 63))))
}
func (m *Params) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 1:
			if wireType != 0 {
				return fmt.Errorf("proto: wrong wireType = %d for field EnableEwasm", wireType)
			}
			var v int
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
		...
		default:
			iNdEx = preIndex
			skippy, err := skipEwasm(dAtA[iNdEx:])
			if err != nil {
				return err
			}
...
func skipEwasm(dAtA []byte) (n int, err error) {
	l := len(dAtA)
	iNdEx := 0
	depth := 0
	for iNdEx < l {
		...
		case 2:
			...
			if length < 0 {
				return 0, ErrInvalidLengthEwasm
			}
			iNdEx += length
		case 3:
			depth++
		case 4:
			if depth == 0 {
				return 0, ErrUnexpectedEndOfGroupEwasm
			}
			depth--
		case 5:
			iNdEx += 4
...
var (
	ErrInvalidLengthEwasm        = fmt.Errorf("proto: negative length found during unmarshaling")
	ErrIntOverflowEwasm          = fmt.Errorf("proto: integer overflow")
	ErrUnexpectedEndOfGroupEwasm = fmt.Errorf("proto: unexpected end of group")
)
