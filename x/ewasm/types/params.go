...
var (
	...
	DefaultEVMDenom = evmtypes.AttoPhoton
...
func NewParams(enableEwasm bool, evmDenom string, enableCreate, enableCall bool, config ChainConfig, extraEIPs ...int64) Params {
	return Params{
...
func (p Params) Validate() error {
	if err := validateBool(p.EnableEwasm); err != nil {
		return err
	}
