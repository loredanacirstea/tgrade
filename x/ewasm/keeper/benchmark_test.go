...
// 	err := suite.app.EwasmKeeper.BankKeeper().MintCoins(suite.ctx, types.ModuleName, amt)
// 	require.NoError(b, err)
// 	err = suite.app.EwasmKeeper.BankKeeper().SendCoinsFromModuleToAccount(suite.ctx, types.ModuleName, suite.address.Bytes(), amt)
// 	require.NoError(b, err)
